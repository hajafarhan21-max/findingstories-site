...
const aliases={
  ...
  propertyType:['prop_type_en','property_type_en','property_type','propertyType'],propertySubtype:['prop_sb_type_en','property_sub_type_en','property_sub_type','propertySubtype'],
  amountAed:['trans_value','actual_worth','transaction_amount','amount_aed','amountAed'],transactionSizeSqm:['procedure_area','transaction_size_sqm'],
