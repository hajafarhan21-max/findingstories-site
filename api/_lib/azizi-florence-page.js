...
export default async function handler(req,res){
  ...
  try{
    ...
    const seo=PUBLIC_PROJECTS.find(item=>item.slug==='azizi-florence');
    const html=renderAziziFlorence({project,campaign:campaigns[0],units,sources,seo,origin:CANONICAL_ORIGIN,whatsappNumber:siteContact.whatsappNumber});
