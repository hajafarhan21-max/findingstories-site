...
export function renderAziziFlorence({project,campaign,units=[],sources=[],origin=CANONICAL_ORIGIN,whatsappNumber=''}){
  ...
  const whatsApp=whatsappNumber?`<a class="button button-outline" data-conversion="whatsapp" target="_blank" rel="noopener noreferrer" href="https://wa.me/${esc(whatsappNumber)}?text=${encodeURIComponent('Hello Finding Stories, I would like to speak with an advisor about Azizi Florence.')}"><span>WhatsApp Advisor</span></a>`:'';
  const mobileWhatsApp=whatsappNumber?`<a data-conversion="whatsapp" target="_blank" rel="noopener noreferrer" href="https://wa.me/${esc(whatsappNumber)}?text=${encodeURIComponent('Hello Finding Stories, I would like to speak with an advisor about Azizi Florence.')}">WhatsApp</a>`:'';
