...
async function database() {
  ...
  for(const migration of ['013_project_ingestion.sql','014_pre_launch_projects.sql','015_large_project_sources.sql'])await db.exec(await readFile(`database/migrations/${migration}`,'utf8'));
