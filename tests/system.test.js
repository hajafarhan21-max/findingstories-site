...
test('production verification delegates deployment and gates it with synthetic writes', async () => {
  ...
  for (const forbidden of ['VERCEL_TOKEN', 'VERCEL_ORG_ID', 'VERCEL_PROJECT_ID', 'ADMIN_PASSWORD']) {
